...
Includes "SpotSpecific.theme":https://github.com/Xalior/oh-my-zsh/raw/master/SpotSpecific_theme.png
@wget --no-check-certificate https://github.com/Xalior/oh-my-zsh/raw/master/tools/install.sh -O - | sh@

Or, on macos
@curl https://raw.github.com/Xalior/oh-my-zsh/master/tools/install.sh| sh -@
